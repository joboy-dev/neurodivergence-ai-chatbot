...
tab1, tab2, tab3, tab4 = st.tabs(['Profile', 'Edit Profile', 'Change Profile Picture', 'Change Password'])
...
with tab4:
    ...
    with st.form("change_password"):
        ...
        change_password_submit = st.form_submit_button("Save Changes", type='primary')
